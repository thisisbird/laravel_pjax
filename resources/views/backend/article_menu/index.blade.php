...
<div class="row">
    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 co-12">
        <section class="card card-fluid">
            ...
            <form id="item_menu_form" action="{{route('backend.articleMenu.delete')}}" method="POST" pjax-container>
                @method('DELETE')
                @csrf
                    ...
                    <li class="dd-item" data-id="2">
                        <div class="dd-handle {{isset($select_menu) && $select_menu->id == $menu_1->id ? 'bg-brand':''}}"> <span class="drag-indicator"></span>
                            ...
                            <div class="dd-nodrag btn-group ml-auto">
                                <a href="{{route('backend.articleMenu.edit',$menu_1->id)}}" class="btn btn-secondary">Edit</a>
                        ...
                        <ol class="dd-list">
                            <li class="dd-item" data-id="5">
                                <div class="dd-handle {{isset($select_menu) && $select_menu->id == $menu_2->id ? 'bg-brand':''}}"> <span class="drag-indicator"></span>
                                    ...
                                    <div class="dd-nodrag btn-group ml-auto">
                                        <a href="{{route('backend.articleMenu.edit',$menu_2->id)}}" class="btn btn-secondary">Edit</a>
                                ...
                                <ol class="dd-list">
                                    <li class="dd-item" data-id="6">
                                        <div class="dd-handle {{isset($select_menu) && $select_menu->id == $menu_3->id ? 'bg-brand':''}}"> <span class="drag-indicator"></span>
                                            ...
                                            <div class="dd-nodrag btn-group ml-auto">
                                                <a href="{{route('backend.articleMenu.edit',$menu_3->id)}}" class="btn btn-secondary">Edit</a>
    ...
    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-12 col-12">
        <div class="card">
            <form action="{{route('backend.articleMenu.update')}}" method="POST" pjax-container>
                @csrf
                <div class="card-body">
                ...
                <div class="card-body border-top">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <input type="checkbox" class="custom-control-input" id="customCheck15" name="is_display" value="1" {{isset($select_menu) ? ($select_menu->is_display ? 'checked':'') : 'checked'}}><label
                            class="custom-control-label" for="customCheck15">是否顯示</label>
                    </div>
                </div>
                ...
                <div class="card-body border-top">
                    @isset($select_menu)
                        ...
                        <a href="{{route('backend.articleMenu.index')}}" class="btn btn-dark btn-lg btn-block">取消</a>
                    @else
